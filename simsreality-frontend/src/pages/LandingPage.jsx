        ...
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-1 md:flex">
            <button
              type="button"
              onClick={guard}
              className="rounded-lg px-3 py-2 text-sm font-medium text-slate-400 transition-colors hover:bg-slate-800 hover:text-[#38bdf8]"
            >
              디지털트윈 목록
            </button>
            ...
            {isLoggedIn ? (
              <>
                <button
                  ...
                  className="hidden items-center gap-2 rounded-lg px-3.5 py-2 text-sm font-semibold transition-all hover:brightness-110 sm:flex"
                  style={{ background: '#38bdf8', color: '#020617' }}
                >
                  내 트윈 보기
                </button>
